...
export default {
    ...
    data() {
        return {
            ...
            toolbarlabel: 'NUEVA NOTA CRÉDITO No: ',
    ...
    created() {
        if (this.$route.meta.mode === 'edit') {
            this.path = `credit-note/${this.$route.params.id}/edit`
            this.store = `credit-note/${this.$route.params.id}`
            this.method = 'put'
            this.button = 'Guardar'
            this.toolbarlabel = 'EDITAR NOTA CRÉDITO No: '
            this.processType = "edit"
        } else if (this.$route.meta.mode === 'clone') {
            this.path = `credit-note/${this.$route.params.id}/edit?convert=clone`
            this.store = `credit-note`
            this.method = 'post'
            this.toolbarlabel = 'CLONAR NOTA CRÉDITO No: '
    ...
    methods: {
        LoadFiles(refs) {
            refs._attachfile.open(this.$route.params.id, 'credit-note');
        },
