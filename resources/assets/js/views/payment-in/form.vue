        ...
        <div>
            ...
            <q-stepper flat ref="stepper" v-model="step" color="secondary" :contractable="contractable">
                <q-step default name="general" title="Datos Generales">
                    <p>
                        Este formulario te guiará atraves del proceso de relacion de recibos de caja. Para comenzar, empieze llenando los siguientes campos.
                    </p>
                ...
                <q-step name="transactiontype" title="Tipo de transacción">
                    ...
                    <q-list link>
                        <q-item tag="label">
                            ...
                            <q-item-main>
                                <q-item-tile label>Asociar pago a Factura de venta</q-item-tile>
...
import paymentInvoice from '../payment-in/payment_datatable.vue'
...
export default {
    ...
    components: {
        QStepper, QStepperNavigation, QStep, QInnerLoading, QSpinnerMat,
        QInput, QField, QSlider, QBtn,kToolbar,
            ...
            if (vm.isInvoice == 1) {
                ...
                axios.get(procedure_path + vm.form.customer_id)
                    .then(function(response) {
                        vm.$set(vm.$data.form, 'pending_payment_in', response.data.PendingByPayment);
