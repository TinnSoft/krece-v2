  ...
  <div class="layout-padding justify-center docs-tab">
    <div style="width: 500px; max-width: 90vw;">
      ...
      <q-modal ref="numerationModal" minimized :content-css="{padding: '20px'}" @close="handleClose">
        ...
        <q-field class="no-margin no-padding" :error="checkIfFieldHasError(errors, 'amount')" error-label="Este campo es obligatorio">
...
export default {
  ...
  methods: {
    ...
    update() {
      var vm = this;
      vm.isProcessing = true;
      axios.put('/api/taxes/' + vm.form.id, vm.form)
        .then(function(response) {
