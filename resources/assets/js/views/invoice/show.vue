<template>
    ...
    <kToolbar toolbarlabel="FACTURA DE VENTA No: " :documentId="public_id" :redirectTo="`/${model}`" @click="$router.push(`/${model}/create`)"
        label2="NUEVA FACTURA DE VENTA" icon2="add_circle_outline"></kToolbar>    
        ...
        <q-fixed-position class="desktop-only" corner="top-right" :offset="[16, 16]">
            <q-fab color="secondary" active-icon="close" direction="down" class="animate-pop">
                ...
                <q-fab-action color="green-6" @click="clone()" icon="content_copy">
                    <q-tooltip anchor="center left" self="center right" :offset="[20, 0]">Anular</q-tooltip>
                </q-fab-action>
