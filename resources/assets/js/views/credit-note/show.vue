<template>
    <div class="layout-padding">
                ...
                <kToolbar toolbarlabel="NOTA CRÉDITO No: " :documentId="public_id" :redirectTo="`/${model}`" @click="$router.push(`/${model}/create`)"
        label2="NUEVA NOTA CRÉDITO" icon2="add_circle_outline"></kToolbar>     
...
export default {
    ...
    components: {
        ...
        QFabAction, QList, QModal, attachfiles,kToolbar
    },
    created() {
        this.fetchData();
    },
    data() {
        return {
            model: 'credit-note',
            path: `credit-note/${this.$route.params.id}`,
            data: {},
            listprice: '',
            contactname: '',
            seller: '',
            totalTaxes: 0,
            table: [],
            pathEmailData: 'getTemplateEmailToCustomerCreditNote'
        }
    },
    watch: {
        '$route': 'fetchData',
